    ...
    loadOrders() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const orders = (result.list || []).map(order => (Object.assign(Object.assign({}, order), { statusLabel: STATUS_LABEL[order.status] || order.status, payAmountYuan: (Number(order.payAmount || 0) / 100).toFixed(2), items: (order.items || []).map(item => (Object.assign(Object.assign({}, item), { unitPriceYuan: (Number(item.unitPrice || 0) / 100).toFixed(2) }))) })));
                this.setData({ orders });
            }
            catch (err) {
